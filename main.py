...
# congiguring app for Sending Emails
app.config.update(
...
def contact():
    if(request.method=='POST'):
        ...
        entry=Contacts(name=name,phone_num=phone,msg=msg,email=email,date=datetime.now())
...
def post_route(post_slug):
    postt=Posts.query.filter_by(slug=post_slug).first()
    return render_template('post.html',params=params,postt=postt)
